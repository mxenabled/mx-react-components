...
function (_React$Component) {
  ...
  function GridLinesGroup() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(GridLinesGroup)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_renderGridLines", function () {
...
_defineProperty(GridLinesGroup, "propTypes", {
...
_defineProperty(GridLinesGroup, "defaultProps", {
  orientation: 'left',
