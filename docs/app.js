  ...
  render() {
    ...
    return (
      <div>
        ...
        {this.props.children}
        <footer>
          <div className="container">&copy; Copyright {currentYear} - MX</div>
        </footer>
      </div>
    );
  }
  ...
  <Router history={hashHistory}>
    <Route component={App} path="/">
      <Route component={Components} path="components">
        ...
        <Route
          component={DatePickerFullScreen}
          path="date-picker-full-screen"
        />
        ...
        <Route
          component={NotifyOnScrollThreshold}
          path="notify-on-scroll-threshold"
        />
