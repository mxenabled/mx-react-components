  ...
  render() {
    return (
      <div>
        ...
        <h3>8.4.0</h3>
        <ul>
          <li>Switch from Glamor to @mxenabled/cssinjs free-style wrapper. No user-facing changes expected.</li>
        </ul>
        ...
        <h3>8.2.9</h3>
        <ul>
          <li>Adds 3rd param to onDateRangeSelect to pass the selectedDefaultRange in the callback.</li>
        </ul>
