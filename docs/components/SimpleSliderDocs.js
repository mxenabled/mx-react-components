  ...
  render () {
    return (
      <div>
        ...
        <h3>Usage</h3>
        <h5>disabled <label>Boolean</label></h5>
        <p>When true, the slider is disabled. This defaults to false.</p>

        <h5>elementRef <label>Function</label></h5>
        <p>A callback function for getting the ref of the wrapping div of the SimpleSlider component.</p>

        <h5>onPercentChange <label>Function</label> <em>Required</em></h5>
