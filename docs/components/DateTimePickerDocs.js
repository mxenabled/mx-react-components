  ...
  render() {
    return (
      <div>
        ...
        <p>
          A function to be called when the user has selected a date. The selected date timestamp
        ...
        <p>Default: 'LT'</p>
        <p>
          This is used to determine the format of the selected time. It should follow the Moment.js
          conventions outlined{' '}
          <a href="http://momentjs.com/docs/#/parsing/string-format/" target="_blank">
            here
          </a>.
        ...
        <p>
          A string used to override the client browser timezone. Should be in the Moment.js
          convention outlined{' '}
          <a
        ...
        <p>
          A string to determine the format of the timezone display. If not included, no timezone
        ...
        <p>
          An object with timezone appbreviations mapped to the name and displayed if the
          timezoneFormat is set to 'name'.
        </p>
        <p>
          Default:{' '}
          {`
