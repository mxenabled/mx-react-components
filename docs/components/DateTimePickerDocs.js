  ...
  render() {
    return (
      <div>
        ...
        <h5>
          calendarStyle <label>Object</label>
        </h5>
        ...
        <h5>
          closeOnDateSelect <label>Boolean</label>
        </h5>
        <p>Default: true</p>
        <p>
          If set to `true`, the calendar will be close after the user selects a
          data.
        </p>

        <h5>
          dateFormat <label>String</label>
        </h5>
        ...
        <p>
          ...
          selected date timestamp will be passed to this function.
        </p>

        <h5>
          selectedDate <label>Number (unix timestamp)</label>
        </h5>
        <p>
          This sets the selected date on the component. Can be used to set a
          default date.
        </p>
        ...
        <h5>
          timeFormat <label>String</label>
        </h5>
        <p>Default: 'LT'</p>
        <p>
          This is used to determine the format of the selected time. It should
          follow the Moment.js conventions outlined{" "}
          <a
            href="http://momentjs.com/docs/#/parsing/string-format/"
            target="_blank"
        ...
        <h5>
          timeIcon <label>String</label>
        </h5>
        <p>Default: 'clock'</p>
        <p>Icon to be shown in the time select box</p>

        <h5>
          timePlaceholder <label>String</label>
        </h5>
        <p>Default: 'Select a Time'</p>
        <p>
          A string used as placeholder text for the selected time input when it
          is empty.
        </p>

        <h5>
          timezone <label>String</label>
        </h5>
        <p>Default: Timezone of client browser</p>
        <p>
          A string used to override the client browser timezone. Should be in
          the Moment.js convention outlined{" "}
          <a
            href="http://momentjs.com/timezone/docs/#/using-timezones/default-timezone/"
            target="_blank"
          >
            here
          </a>.
        ...
        <h5>
          timeFormat <label>One of 'abbr' or 'name'</label>
        </h5>
        <p>
          A string to determine the format of the timezone display. If not
          included, no timezone information will be displayed.
        </p>

        <h5>
          timezoneNames <label>Object</label>
        </h5>
        <p>
          An object with timezone appbreviations mapped to the name and
          displayed if the timezoneFormat is set to 'name'.
        </p>
        <p>
          Default:{" "}
          {`
