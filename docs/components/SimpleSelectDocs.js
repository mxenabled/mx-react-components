  ...
  render() {
    return (
      <div>
        ...
        <h3>Demo</h3>
        <div style={{ width: 177 }}>
          <Button icon="gear" onClick={this._toggleMenu} type="neutral">
            Settings
          </Button>
          {this.state.showMenu ? (
            <SimpleSelect
        ...
        <h5>
          onScrimClick <label>function</label>
        </h5>
        <p>
          <em>onClick</em> handler for the menu scrim.
        </p>
