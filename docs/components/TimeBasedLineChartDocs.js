  ...
  render () {
    ...
    return (
      <div>
        ...
        <h5>shadeBelowZero <label>Boolean</label></h5>
        <p>Default: false</p>
        <p>If set to 'true', then the area below zero will be shaded. This is set to 'true' in the example above.</p>

        <h5>shadeFutureOnGraph <label>Boolean</label></h5>
        <p>Default: true</p>
        <p>Set this to 'false' if don't want any part of the graph that is in the future to be shaded.</p>
        ...
        <h5>zeroState <label>Node</label></h5>
