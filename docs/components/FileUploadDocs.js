  ...
  render() {
    return (
      <div>
        ...
        <h3>Usage</h3>
        <h5>
          allowedFileTypes <label>Array</label>
        </h5>
        <p>An array of file types and extensions allowed for upload.</p>

        <h5>
          imageValidation <label>Object</label>
        </h5>
        ...
        <ul>
          <li>
            <h5>
              exactHeight<label>exact height in pixels</label>
            </h5>
          </li>
          <li>
            <h5>
              exactWidth<label>exact width in pixels</label>
            </h5>
          </li>
          <li>
            <h5>
              maxHeight<label>maximum height in pixels</label>
            </h5>
          </li>
          <li>
            <h5>
              maxWidth<label>maximum width in pixels</label>
            </h5>
          </li>
          <li>
            <h5>
              minHeight<label>minimum height in pixels</label>
            </h5>
          </li>
          <li>
            <h5>
              minWidth<label>minimum width in pixels</label>
            </h5>
          </li>
          <li>
            <h5>
              ratioHeight<label>ratio of height compared to width</label>
            </h5>
          </li>
          <li>
            <h5>
              ratioWidth<label>ratio of width compared to height</label>
            </h5>
          </li>
        </ul>
        ...
        <h5>
          OnFileAdd <label>function</label>
        </h5>
        <p>Event handler for when a file is added.</p>

        <h5>
          OnFileRemove <label>function</label>
        </h5>
