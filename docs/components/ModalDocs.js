...
class ModalDocs extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>
          An array of objects with the properties: actionText, className,
          isActive, icon, label, onClick, style, and type. Used to display
          button in the footer of the modal. Example:
        </p>
        <Markdown>
          {`
    [{
  ...
  `}
        ...
        <p>
          A style object used to style the content div that wrapps the
          modal&#39;s content
        </p>
        ...
        <p>
          A style object used to style the footer div that wrapps the
          modal&#39;s footer
        </p>
        ...
        <p>Default: 'false'</p>
        <p>
          If set to 'true', then the modal will be positioned absolute instead
          of fixed.
        </p>
        ...
        <p>
          A method that is called when the close button or scrim area is clicked
          by a user. Use this method to tell the Modal when it should close.
        </p>
        ...
        <p>Default: 'true'</p>
        <p>
          Determines if the close icon is displayed in the top right corner of
          the Modal. The Modal can still be closed by clicking on the scrim.
        </p>
        ...
        <p>Default: 'false'</p>
        <p>
          Determines if the footer section, which contains the tooltip and
        ...
        <p>Default: 'false'</p>
        <p>
          Determines if the title bar section, which contains the title, is
          displayed.
        </p>
        ...
        <p>
          The text to be displayed in the title bar at the top of the modal.
        </p>
        ...
        <p>
          The text to be displayed next to the tooltip icon. Hovering over this
          text will display the tooltip.
        </p>
        ...
        <p>
          The tooltip title text, which is displayed above the tooltip text and
          only when hovering over the label.
        </p>
