...
class DonutChartDocs extends React.Component {
    ...
    return (
      <div>
        <h1>
          DonutChart
          <label>
            A D3 donut chart that supports a center label, multiple slices, and reference dots.
          </label>
        </h1>
        ...
        <p>
          Required for hover animations and data labels. Used to determine which slice is currently
          active. Represented visually by making the slice slightly larger or zoomed in and
          displaying the data label.
        </p>
        ...
        <p>Default: roll</p>
        <p>
          Determines which of two animations will be used when chart is loaded or data is changed.
          Roll will rotate the chart in while pop will bounce the chart in.
        </p>
  ...
  `}
        ...
        <p>
          A method to be called when a pie slice is clicked. It will be passed the <code>data</code>{' '}
          at the clicked index.
        </p>
        ...
        <p>
          A method to be called when the mouse hovers over a slice. It will be passed the index of
        ...
        <p>
          A method to be called when the mouse leaves a slice. It will be passed the index of the
          hovered data point.
        </p>
