...
class DonutChartDocs extends React.Component {
    ...
    return (
      <div>
        <h1>
          DonutChart
          <label>
            A D3 donut chart that supports a center label, multiple slices, and
            reference dots.
          </label>
        </h1>
        ...
        <h3>Usage</h3>
        <h5>
          activeIndex <label>Number</label>
        </h5>
        <p>
          Required for hover animations and data labels. Used to determine which
          slice is currently active. Represented visually by making the slice
          slightly larger or zoomed in and displaying the data label.
        </p>

        <h5>
          activeOffset <label>Number</label>
        </h5>
        <p>Default: 3</p>
        ...
        <h5>
          animationDuration <label>number</label>
        </h5>
        <p>Default: 500</p>
        <p>Determines how long the load animation is in milliseconds</p>

        <h5>
          animationTypeOnLoad <label>string</label>
        </h5>
        <p>Default: roll</p>
        <p>
          Determines which of two animations will be used when chart is loaded
          or data is changed. Roll will rotate the chart in while pop will
          bounce the chart in.
        </p>

        <h5>
          arcWidth <label>Number</label>
        </h5>
        <p>Default: 80</p>
        ...
        <p>
          <em>(required)</em> An array of data objects. Example:
        </p>
        <Markdown lang="js">
          {`
    [{
  ...
  `}
        ...
        <h5>
          dataPointColors <label>Array</label>
        </h5>
        <p>Default: D3 Generated Colors</p>
        <p>
        ...
        <h5>
          dataPointRadius <label>Number</label>
        </h5>
        <p>Default: 40</p>
  ...
  `}
        ...
        <h5>
          dropdownStyle <label>Object | Array</label>
        </h5>
        <p>
          A Radium style object or array that will be applied to the dropdown
          select box.
        </p>
        ...
        <p>
          A method to be called when a pie slice is clicked. It will be passed
          the <code>data</code> at the clicked index.
        </p>

        <h5>
          onMouseEnter <label>Function</label>
        </h5>
        <p>
          A method to be called when the mouse hovers over a slice. It will be
          passed the index of the hovered data point.
        </p>

        <h5>
          onMouseLeave <label>Function</label>
        </h5>
        <p>
          A method to be called when the mouse leaves a slice. It will be passed
          the index of the hovered data point.
        </p>

        <h5>
          opacity <label>Number</label>
        </h5>
        <p>Default: 1</p>
        <p>The opacity of the entire DonutChart component.</p>

        <h5>
          padAngle <label>Number</label>
        </h5>
        <p>Default: 0.01</p>
        <p>A number, in degrees, that sets the space between slices.</p>

        <h5>
          showBaseArc <label>Boolean</label>
        </h5>
        <p>Default: false</p>
        <p>
        ...
        <h5>
          showDataLabel <label>Boolean</label>
        </h5>
        <p>Default: true</p>
        <p>
