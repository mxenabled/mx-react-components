  ...
  _renderDataLabel = (styles, colors) => {
    if (this.props.showDataLabel) {
      if (this.props.children) {
        ...
        const text =
          this.state.activeIndex === -1 ? this.props.defaultLabelText : activeDataSet.name
        const value =
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <svg className="mx-donutchart-svg" height={this.props.height} width={this.props.width}>
