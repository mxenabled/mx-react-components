      ...
      <div className="toggle-switch-component" style={styles.component}>
        {this.props.showLabels ? (
          <div
            ...
            style={Object.assign(
              {},
              styles.label,
              this.props.checked ? styles.inactiveLabel : styles.activeLabel
            )}
          >
        ...
        <div
          ...
          style={Object.assign(
            {},
            styles.track,
            styles[this.props.checked + "Track"]
          )}
        >
          {this.props.showIcons ? (
            <span>
              <Icon
                className="true-icon"
                style={Object.assign({}, styles.icon, styles.trueIcon)}
                type={this.props.trueIcon}
              />
              <Icon
                className="false-icon"
                style={Object.assign({}, styles.icon, styles.falseIcon)}
        ...
        {this.props.showLabels ? (
          <div
            ...
            style={Object.assign(
              {},
              styles.label,
              this.props.checked ? styles.activeLabel : styles.inactiveLabel
            )}
          >
