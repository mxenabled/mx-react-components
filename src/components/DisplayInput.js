...
class DisplayInput extends React.Component {
  ...
  render() {
    ...
    const showHint =
      this.props.showHint && !this.props.status && isLargeOrMediumWindowSize;
            ...
            {showHint ? (
              <Column span={twoWidthColumn}>
                <div style={styles.hint}>
                  {this.props.showHint && !this.props.status ? (
          ...
          {this.props.status ? (
            <Column offset={twoWidthColumn} span={statusColumn}>
              <div style={styles.status}>
                <div style={styles[this.props.status.type]}>
    ...
    return _merge(
      {},
      {
        ...
        labelText: {
          ...
          paddingBottom: isLargeOrMediumWindowSize
            ? theme.Spacing.MEDIUM
            : theme.Spacing.XSMALL,
          paddingLeft: theme.Spacing.SMALL,
          paddingRight: theme.Spacing.SMALL,
          paddingTop: isLargeOrMediumWindowSize
            ? theme.Spacing.MEDIUM
            : theme.Spacing.XSMALL,
          textAlign: "left"
        },
        ...
        status: {
          ...
          paddingLeft: isLargeOrMediumWindowSize
            ? theme.Spacing.SMALL
            : theme.Spacing.XSMALL,
          paddingRight: theme.Spacing.SMALL,
