...
class DatePicker extends React.Component {
  ...
  _handleDateSelect = (date, e) => {
    ...
    const hour = this.props.selectedDate
      ? moment.unix(this.props.selectedDate).hour()
      : 0;
    const minutes = this.props.selectedDate
      ? moment.unix(this.props.selectedDate).minute()
      : 0;
  ...
  styles = theme => {
    return Object.assign(
      {},
      {
        ...
        selectedText: {
          color: this.props.selectedDate
            ? theme.Colors.GRAY_700
            : theme.Colors.GRAY_500,
          flex: 1
        },
        selectedDateCaret: {
          fill: this.state.showCalendar
