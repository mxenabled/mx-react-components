        ...
        >
          <g transform={`translate(${margin.left},${margin.top})`}>
            {this.props.data.map(d => {
              ...
              const clicked =
                this.state.clickedData.value === d.value && this.state.clickedData.label === d.label
              const hovering =
                this.state.hoveringObj.value === d.value && this.state.hoveringObj.label === d.label
              ...
              if (clicked) {
                style = Object.assign(
                  {},
                  baseStyle,
                  positive ? styles.positiveBarClicked : styles.negativeBarClicked,
                )
              } else if (hovering) {
                style = Object.assign(
                  {},
